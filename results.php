...
<body>
 <?php
	...
	require_once("./library.php"); // To connect to the database
 	...
 	$check = htmlspecialchars($_POST['school']) . htmlspecialchars($_POST['state']) . htmlspecialchars($_POST['sport']) . htmlspecialchars($_POST['gender']) . htmlspecialchars($_POST['p_fname']) . htmlspecialchars($_POST['p_lname']) . htmlspecialchars($_POST['c_fname']) . htmlspecialchars($_POST['c_lname']);

 	if (strcspn($check, "0123456789'") == strlen($check)) {
